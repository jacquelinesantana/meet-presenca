...
- **Exportação CSV simplificada** (E-mail;Data) — ideal para sistemas de presença
...
**Deduplicação automática (v1.5.1+)**: Se a mesma pessoa aparecer com nomes diferentes (ex: "João Silva" e "João Silva - Coordenador"), mas receber o mesmo e-mail, o CSV exporta apenas **uma linha** com o **maior tempo de permanência**. A extensão mostra quantas duplicatas foram removidas.

**Formato do CSV gerado:**
```
E-mail;Data
joao.silva@escola.com;15/09/2026
maria.santos@escola.com;15/09/2026
pedro.oliveira@escola.com;15/09/2026
```

**Importante:**
- Apenas participantes **com e-mail** aparecem no CSV
- A data é sempre a data do dia da exportação
...
### CSV exportado vazio ou com poucos participantes
**Problema:** O CSV tem apenas o cabeçalho ou muito menos participantes do que o esperado.
...
- **Google mudou a interface:** ajuste os seletores em `content/selectors.js` (arquivo centralizado e comentado para manutenção)
